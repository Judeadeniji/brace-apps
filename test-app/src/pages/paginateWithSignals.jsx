import { use, signal, useEffect, signalEffect, useRef } from "@mejor";
import { Link } from "@mejor/router"

export function Metadata() {
  return {
    title: "Test App For use() Hook + signals",
    description: "Testing the use() hook in Mejor Framework",
  };
}

const totalItems = 20; // Total number of items in the data
...
function DataComponent() {
 ...
 signalEffect(handleRefresh, currentPage)
...
export default function PaginateWithSignals() {
  return (
    <div key="PaginateWithSignals" class="mx-auto max-w-3xl px-4">
      <h1 class="text-3xl font-bold mt-3">Mock Data List Using Signals</h1>
